#ifndef CXX20_GENERATOR_HXX
#define CXX20_GENERATOR_HXX
...
struct Generator
{
    ...
    Generator(handle_type h) : mHandle(h)
    {
    ...
    T operator()()
    {
        ...
        return std::move(mHandle.promise().value_);
    }
...
private:
    ...
    void fill()
    {
        ...
        {
            mHandle();
            if (mHandle.promise().exception_)
                std::rethrow_exception(mHandle.promise().exception_);
